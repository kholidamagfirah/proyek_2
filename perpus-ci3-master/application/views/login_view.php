...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/Buku-5.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: White;"><b>SISTEM INFORMASI<br/><b>PERPUSTAKAAN BERBASIS WEB</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: White;"> Copyright &copy; Kholida Magfirah (1204003) & Wulan Nur Annisah (1204007) <?php ;?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
